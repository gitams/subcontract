<h3 style="text-align: center; margin-top: 3px;"><label>Search for Employers</label></h3><hr/>
<script src="<?php echo base_url('assets/js/tabcontent.js')?>" type="text/javascript"></script>

<div class="user">
    <div class="col-md-12">
        <div class="col-sm-3 control-label"><br/><label for="contact-name" >Employer Name<span style="color: #FF0000"> *</span></label></div>
...
<div class="form-group" id="searchResultDiv">
    <?php include('layout/self_user_emp_search_result_div.php');?>
</div>
<script>
    $(document).ready(function () {
        $(document).on('click', '#search', function () {
            ...
            $.ajax({
                url: '<?php echo base_url('user_dashboard/selfUserSearchEmpResult');?>',
                type: 'POST',
