...
<div class="dash-wrap">
    <div class="dash-container">
        <div class="dash-header">
            <div class="dash-logo"><img src="<?php echo base_url('assets/images/logo.png');?>" alt=""></div>
            ...
            <form action="<?php echo base_url('no_profile/saveSelfUser') ?>" name="addCandidate" id="addCandidate" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                <div class="form-group">
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="su_first_name" class="form-control" id="su_first_name" value="<?php echo $profile->first_name;?>" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="su_last_name" class="form-control" id="su_last_name" value="<?php echo $profile->last_name;?>" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="su_mobile" class="form-control" id="su_mobile" value="<?php echo $profile->phonenumber;?>"  maxlength="10" pattern="\d{10}" required="required" title="only 10 digits">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" rows="4" id="su_email" name="su_email" value="<?php echo $profile->username;?>" required="required"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
