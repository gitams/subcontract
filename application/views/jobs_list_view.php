                ...
                foreach ($jobs as $job) {
                    ...
                    if($job->ja_applied_acc_id != $accountId) { ?>
                        <div class="vendors2" style="width: 100%;">
                            ...
                            <div class="each_job_post">
                                <div class="view_apply_div"><a href="<?php echo base_url('dashboard/jobViewApply')."/".$job->post_id.""."/".$job->accid;?>" class="btn btn-primary">View & Apply</a></div>
