...
class User_dashboard extends CI_Controller
{
    ...
    function __construct()
    {
		...
		$countAppliedJobs = $this->_requestRelations_model->fetchSelfuserAppliedJobsCount($contactId);
        $this->_viewArray['appliedJobsCount'] = $countAppliedJobs->num_rows();
	...
	public function recentJobPost() {
        try{
            $this->_viewArray['skillsObj'] = $this->_jobOperations_model;
            $this->_viewArray['page'] = 'recent_job_post_view';
            $this->_view('Add Your Profile', $this->_viewArray);
        }catch (Exception $ex){
            echo $ex->getMessage();
            exit;
    ...
    public function jVApplyUser($jobPostId,$PostedAccId){
        try{
            $this->_viewArray['page'] = 'self_user_apply_view';
	 ...
	 public function selfUserAppliedJobs(){
        try{
			$userDetails = $this->session->userdata('userLoginDetails');
			$postid = $userDetails->contactid;
			$this->_viewArray['page'] = 'applied_job_view';
            $this->_viewArray['resultJob'] = $this->_jobOperations_model->selfUserFetchAppliedJobs($postid);
